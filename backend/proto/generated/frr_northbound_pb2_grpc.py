...
from . import frr_northbound_pb2 as frr__northbound__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in frr_northbound_pb2_grpc.py depends on'
